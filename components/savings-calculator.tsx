            ...
            <div className="space-y-4">
              <div className="compact-form-group">
                <div className="flex items-center justify-between">
                  <Label htmlFor="monthly-savings" className="compact-label flex items-center gap-1">
                    Monthly Savings
                    <TooltipProvider>
                      <Tooltip>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Card className="bg-secondary/30 border-none">
                  <CardContent className="p-2.5">
                    ...
                    <div className="text-base font-bold">CHF {formatNumber(monthlySavings * 12)}</div>
                  </CardContent>
                </Card>
              </div>
                  ...
                  {[1, 2, 3, 5, 10, 15, 20, 25, 30]
                    ...
                    .map((milestone) => (
                      ...
                      >
                        ...
                        <span className="text-xs font-medium">CHF {formatNumber(monthlySavings * 12 * milestone)}</span>
                      </div>
                    ))}
                </div>
              </div>
