    ...
    <div className="grid gap-4 md:grid-cols-2">
      <Card className="card-hover border-l-4 border-l-navy compact-card">
        <CardHeader className="card-header">
          ...
          <CardDescription className="text-xs">Calculate your investment growth over time</CardDescription>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              <div className="compact-form-group">
                <Label htmlFor="initial-investment" className="compact-label flex items-center gap-1">
                  Initial Investment
                  <TooltipProvider>
                    <Tooltip>
              ...
              <div className="compact-form-group">
                <Label htmlFor="monthly-contribution" className="compact-label flex items-center gap-1">
              ...
              <div className="compact-form-group">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-medium bg-secondary px-1.5 py-0.5 rounded-md">{annualReturn}%</span>
                </div>
                <Slider
                  id="annual-return"
                  min={1}
              ...
              <div className="grid grid-cols-1 gap-3">
                <Card className="bg-secondary/30 border-none">
                  <CardContent className="p-2.5">
                    ...
                    <div className="text-base font-bold text-positive">CHF {formatNumber(finalAmount)}</div>
                  </CardContent>
                </Card>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card className="bg-secondary/30 border-none">
                    <CardContent className="p-2.5">
                      ...
                      <div className="text-sm font-bold">CHF {formatNumber(totalContributions)}</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-secondary/30 border-none">
                    <CardContent className="p-2.5">
                      <div className="text-xs text-muted-foreground">Total Interest</div>
                      <div className="text-sm font-bold text-primary">CHF {formatNumber(totalInterest)}</div>
                    </CardContent>
                  </Card>
                </div>
              </div>
